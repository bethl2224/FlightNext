  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Failed to retrieve flight details");
      }

      const data = await response.json();
      setFlightDetails(data);
    } catch (err) {
      console.error("Error verifying flight:", err);
    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {flightDetails && (
        <div className="mt-8 p-6 bg-gray-100 rounded-lg shadow-lg">
          ...
          <p>
            <strong>Booking Reference:</strong> {flightDetails.bookingReference}
          </p>
          <p>
